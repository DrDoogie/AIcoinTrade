...
SYMBOLS = ["PLTR", "NVDA","IONQ","TSLA","MSFT","AAPL","GOOGL","TSM","SPYD","SCHD","MAIN"]  # 여러 심볼 추가
...
DEFAULT_CONFIG = {
    ...
    'stop_loss_percent': 8,             # 손절매 기준: 하락률 (%)
...
SYMBOL_CONFIGS = {
    ...
    "SPYD": {
        ...
        'stop_loss_percent': 7,         # 배당주는 상대적으로 안정적
    ...
    "MAIN": {
        ...
        'stop_loss_percent': 8,         # REIT는 중간 변동성
                            ...
                            if buy_signal:
                                ...
                                try:
                                    ...
                                    if symbol in stock_dict:
                                        ...
                                        if current_price and current_price > 0:
                                            # 수익률이 부분 익절 목표 이상이면 체크 (함수 내부에서 조건 확인)
