...
TRADING_CONFIG = {
    ...
    'MAX_TRADE_PERCENTAGE': 1.0,    # 최대 거래 비중 30.0
    'TRADE_WEIGHT_LEVELS': {
    'low': 0.01,     # 10% 비중
    'medium': 0.02,  # 20% 비중
    'high': 0.03    }  # 30% 비중
    ...
    try:
        ...
        if order:
            ...
            trade_data = {
                ...
                'take_profit_price': current_price * 1.015,
...
def main():
    ...
    try:
        ...
        start_message = (
            "🚀 비트코인 트레이딩 봇 시작\n"
            f"• 실행 시간: 매일 06:00, 12:00, 18:00, 00:00\n"
        ...
        schedule.every().day.at("23:13").do(trading_bot)
